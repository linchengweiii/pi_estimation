...
#ifndef PI_DIGIT_ESTIMATOR_H
#define PI_DIGIT_ESTIMATOR_H
...
private:
    ...
    static int inv_mod2(int u, int v)
    {
...
public:
    static int get_nth_digit_of_pi(int n, int& result)
    {
        ...
        return result = (int) (sum * 1e9);
    }
};

#endif // PI_DIGIT_ESTIMATOR_H
